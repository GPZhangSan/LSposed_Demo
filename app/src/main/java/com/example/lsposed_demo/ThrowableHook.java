...
public class ThrowableHook implements IXposedHookLoadPackage {
    @Override
    ...
    private void hook(XC_LoadPackage.LoadPackageParam lpparam) {
        // hook
        XposedHelpers.findAndHookMethod(Throwable.class, "getStackTrace", lpparam.classLoader, new XC_MethodHook() {
            // 执行完之后
            @Override
